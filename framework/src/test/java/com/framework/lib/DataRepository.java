...
public class DataRepository {
	...
	public static Object[][] createData(Method testMethod){		
		...
		readExcel(System.getProperty("user.dir")+"/src/test/resources/testdata/"+testClassName+".xlsx",testMethod.getName(),parameters);
				...
				if(rowNumber == 0){
					while(cellIterator.hasNext()) {		             
						...
						case Cell.CELL_TYPE_NUMERIC: {
							...
							numericString = new Double(numericValue).toString();
